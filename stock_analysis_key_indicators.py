...
def Get_Key_Indicators(stock):  
    ...
    results_cash['Data'] = 'Cash'
    results_cash['Date Run'] = mods.Today()
    results_cash['Cash_Test'] = is_positive_cash
    ...
    results_ni['Data'] = 'Net Income'
    results_ni['Date Run'] = mods.Today()
    results_ni['Net Income Test'] = is_positive_ni
    ...
    debt_data['Data'] = 'Long Term Debt'    
    debt_data['Date Run'] = mods.Today()
    ...
    invest_data['Data'] = 'Long Term Investment'    
    invest_data['Date Run'] = mods.Today()
    ...
    return [json.dumps(results), json.dumps(results_cash), json.dumps(results_ni), json.dumps(invest_data), json.dumps(debt_data)]
